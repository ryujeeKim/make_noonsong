...
public class noonsong_growth extends JFrame {
    private JLabel imageLabel;
    private JLabel textLabel;
    private String text = "눈송이 성장중...";
    ...
    public noonsong_growth() {
        ...
        JPanel panel = new noonsong_growth.CustomPanel();
        panel.setLayout(null);
        setContentPane(panel);

        // 이미지 불러오기
        //java.net.URL imageUrl = getClass().getResource("/img_6.png"); // 사진 바꿔야댐
        // if (imageUrl == null) {
        ...
        //stage에 맞는 이미지를 받아옴
        String ImgIcn = Snowflake.stages[Snowflake.stage];
